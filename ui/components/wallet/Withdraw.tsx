  ...
  return (
    <Dialog>
      ...
      <DialogContent className="min-w-[700px] gap-2 border-[0.1px] border-white/12 bg-black/100 sm:max-w-md">
        ...
        {/* cut */}
        <section>
          <p className="subtext text-white/50">Gas Fee</p>
          <div className="flex items-center space-x-2">
            <div className="grid flex-1 gap-2">
              <Label htmlFor="Gas Fee" className="sr-only">
                Gas Fee
              </Label>
              <Input
                id="Gas Fee"
                value={"Slow (Fee: 0.0 COIN)"}
                className="h-[48px] border-white/12 p-4 text-white/100"
        ...
        <section>
          <p className="subtext text-white/50">Wallet Address</p>
        ...
        <section>
          <p className="subtext text-white/50">You will receive</p>
          <div className="flex items-center space-x-2">
            <div className="grid flex-1 gap-2">
              <Label htmlFor="amount" className="sr-only">
                Amount
