...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: "Failed to fetch player" }, {
      status: 500,
      headers: { "Content-Type": "application/json" },
    });
  }
...
export async function PUT(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: "Failed to update player" }, {
      status: 500,
      headers: { "Content-Type": "application/json" },
    });
  }
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: "Failed to delete player" }, {
      status: 500,
      headers: { "Content-Type": "application/json" },
    });
  }
