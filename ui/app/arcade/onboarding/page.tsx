          ...
          <>
            ...
            <div>
              ...
              <input
                ...
                className="title h-[50px] w-full border-b border-green/100 bg-transparent p-4 text-white/50 placeholder-grey-100 focus:outline-none"
              />
          ...
          <>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div
                ...
                className="relative flex h-[200px] w-full cursor-pointer flex-col items-center justify-center rounded-md bg-white/100"
              >
                {!selectedImage ? (
                  <>
                    <img
                ...
                <input
                  ...
                  className="absolute inset-0 cursor-pointer opacity-0" // Removed 'hidden'
                />
              </div>
          ...
          <>
            ...
            <div>
              ...
              <input
                ...
                className="h-[82px] w-full rounded-md bg-white/10 p-4 text-white/100"
              />
              <p className="mt-2 text-sm text-green/100">
